...
static void set_token_calls(struct template_state *tmpl, const char *name, const char *value, int argc, char **argv)
{
...
void functions_init(struct template_state *tmpl)
{
    ...
    tmpl->put(tmpl, "set_token_calls", "", set_token_calls);
